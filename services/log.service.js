...
const printWeather = async (data, icon) => {
	...
	${chalk.magenta('Temperature: ' + data.main.temp + ' ( Min: ' + data.main.temp_min + ' | Max: ' + data.main.temp_max + ' | Feels like: ' + data.main.feels_like +' )')}
	${chalk.magenta('Humidity: ' + data.main.humidity + ' | Wind Speed: ' + data.wind.speed)}
